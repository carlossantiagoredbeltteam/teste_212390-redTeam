...
LIBS:power,device,conn,linear,regul,reprap,74xx,cmos4000,adc-dac,memory,xilinx,special,microcontrollers,microchip,analog_switches,motorola,intel,audio,interface,digital-audio,philips,display,cypress,siliconi,.\comms_and_power_distribution.cache
EELAYER 23  0
EELAYER END
$Descr A4 11700 8267
Sheet 1 1
...
F 1 "78L05" H 3350 2600 60  0000 C C
	1    3350 2400
	1    0    0    -1  
$EndComp
Kmarq B 5650 4600 "Warning Pin power_in not driven (Net 20)" F=1
Kmarq B 3450 4000 "Warning Pin power_in not driven (Net 3)" F=1
NoConn ~ 2350 2600
...
U 1 1 46B87CA5
P 3100 5000
F 0 "#PWR02" H 3100 4950 20  0001 C C
...
U 1 1 46319B6C
P 2300 4250
F 0 "#PWR07" H 2300 4250 30  0001 C C
...
U 1 1 46319B62
P 3450 4000
F 0 "#PWR08" H 3450 3950 20  0001 C C
...
U 1 1 463198A7
P 2600 4100
F 0 "P09" H 2600 4100 60  0000 C C
...
U 1 1 45A40DA1
P 3100 6200
F 0 "#PWR010" H 3100 6200 30  0001 C C
...
U 1 1 45A40C07
P 9100 3200
F 0 "#PWR011" H 9100 3200 30  0001 C C
...
U 1 1 45A40BF0
P 10150 4450
F 0 "#PWR012" H 10150 4450 30  0001 C C
...
U 1 1 45A40B48
P 8450 2450
F 0 "#PWR013" H 8450 2540 20  0001 C C
...
U 1 1 45A40A81
P 2550 2900
F 0 "#PWR014" H 2550 2900 30  0001 C C
...
U 1 1 45A40A6C
P 3900 2200
F 0 "#PWR015" H 3900 2290 20  0001 C C
