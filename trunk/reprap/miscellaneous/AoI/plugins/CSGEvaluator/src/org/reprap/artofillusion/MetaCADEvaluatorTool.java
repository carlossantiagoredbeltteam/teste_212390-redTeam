...
public class MetaCADEvaluatorTool implements ModellingTool
{
  ...
  { 
    KeystrokeManager.addRecord(new KeystrokeRecord(KeyEvent.VK_M, 0, "MetaCAD Evaluator",
        ...
        "PluginRegistry.getPluginObject(\"org.reprap.artofillusion.MetaCADEvaluatorTool\");" +
  ...
  public void commandSelected(LayoutWindow window)
  {
    ...
    if (this.dialog != null && this.dialog.isVisible() && this.dialog.getParent() == window) {
      ...
      this.dialog = new MetaCADEvaluatorDialog(window);
    }
