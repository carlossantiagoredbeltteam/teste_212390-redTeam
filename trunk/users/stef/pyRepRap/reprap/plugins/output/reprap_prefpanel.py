...
class PreferencesPanel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.pref_stepsPerMillimeterX = 30
        self.pref_stepsPerMillimeterY = 30
        self.pref_limitX = 2700
        self.pref_limitY = 2500
        self.pref_enableLimit = True
        self.pref_torque = 90        # 83    (old values)
        self.pref_speed = 230        # 220
