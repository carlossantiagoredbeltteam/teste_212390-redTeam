...
//ERIK
#define MODIFIER_PIN (byte)3 // analoque input!

//extruder pins
#define EXTRUDER_0_MOTOR_SPEED_PIN   (byte)19
#define EXTRUDER_0_MOTOR_DIR_PIN     (byte)10
#define EXTRUDER_0_HEATER_PIN        (byte)12
#define EXTRUDER_0_FAN_PIN           (byte)13
...
#define EXTRUDER_0_STEP_ENABLE_PIN  (byte)16  // 3 - Conflicts with the fan; set -ve if no stepper

#define EXTRUDER_1_MOTOR_SPEED_PIN   (byte)19
#define EXTRUDER_1_MOTOR_DIR_PIN    (byte)10
#define EXTRUDER_1_HEATER_PIN        (byte)13
#define EXTRUDER_1_FAN_PIN           (byte)13
#define EXTRUDER_1_TEMPERATURE_PIN  (byte)4  // Analogue input
#define EXTRUDER_1_VALVE_DIR_PIN    (byte)17
#define EXTRUDER_1_VALVE_ENABLE_PIN (byte)13   // Valve needs to be redesigned not to need this 
#define EXTRUDER_1_STEP_ENABLE_PIN  (byte)16  // 7 - Conflicts with the fan; set -ve if no stepper
