...
class MetaCADEvaluatorDialog extends BDialog
{
  ...
  {
    super(window, "MetaCAD Evaluator ", false); // Modeless
    ...
    */
    ...
    bc.add(new BLabel("<html>MetaCAD Evaluator Control Panel <font size=1>V"+versionstr+"</font></html>"), BorderContainer.NORTH);
